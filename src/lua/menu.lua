...
local NavigationMenu = addmenu("Navigation",
{
	...
	{"ZSU",    nil, "Selection up",               "SUP",       function() Cmd.SetMark() Cmd.GotoPreviousLine() end},
	{"ZSR",    nil, "Selection right",            "SRIGHT",    function() Cmd.SetMark() Cmd.GotoNextCharW() end},
	{"ZSD",    nil, "Selection down",             "SDOWN",     function() Cmd.SetMark() Cmd.GotoNextLine() end},
	{"ZSL",    nil, "Selection left",             "SLEFT",     function() Cmd.SetMark() Cmd.GotoPreviousCharW() end},
	{"ZSW",    nil, "Select word",                "^W",        Cmd.SelectWord},
	{"ZWL",    nil, "Goto previous word",         "^LEFT",     Cmd.GotoPreviousWordW},
	{"ZWR",    nil, "Goto next word",             "^RIGHT",    Cmd.GotoNextWordW},
	{"ZNP",    nil, "Goto next paragraph",        "^DOWN",     Cmd.GotoNextParagraphW},
	{"ZPP",    nil, "Goto previous paragraph",    "^UP",       Cmd.GotoPreviousParagraphW},
	{"ZH",     nil, "Goto beginning of line",     "HOME",      Cmd.GotoBeginningOfLine},
	{"ZE",     nil, "Goto end of line",           "END",       Cmd.GotoEndOfLine},
	{"ZBD",    nil, "Goto beginning of document", "^PGUP",     Cmd.GotoBeginningOfDocument},
	{"ZED",    nil, "Goto end of document",       "^PGDN",     Cmd.GotoEndOfDocument},
	{"ZPGUP",  nil, "Page up",                    "PGUP",      Cmd.GotoPreviousPage},
	{"ZPGDN",  nil, "Page down",                  "PGDN",      Cmd.GotoNextPage},
	{"ZDPC",   nil, "Delete previous character",  "BACKSPACE", Cmd.DeletePreviousChar},
	{"ZDNC",   nil, "Delete next character",      "DELETE",    Cmd.DeleteNextChar},
	{"ZDW",    nil, "Delete word",                "^E",        Cmd.DeleteWord},
