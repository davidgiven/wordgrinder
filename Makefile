...
install: bin/wordgrinder bin/xwordgrinder bin/wordgrinder.1
	@echo INSTALL
	$(hide)install -d                       $(DESTDIR)$(PREFIX)/bin
	$(hide)install -m 755 bin/wordgrinder   $(DESTDIR)$(PREFIX)/bin/wordgrinder
	$(hide)install -m 755 bin/xwordgrinder  $(DESTDIR)$(PREFIX)/bin/xwordgrinder
